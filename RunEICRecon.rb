...
# i/o parameters
in_ddsim   = "./testRawHGCROCHit.e10pim_central.d19m8y2024.edm4hep.root"
out_podio  = "testRawHGCROCHit.e10pim_central.d19m8y2024.podio.root"
out_plugin = "testRawHGCROCHit.e10pim_central.d19m8y2024.plugin.root"
...
# run EICrecon
exec("eicrecon -Pplugins=#{arg_plugin} -Ppodio:output_include_collections=#{arg_collect} #{arg_option} -Ppodio:output_file=#{out_podio} -Phistsfile=#{out_plugin} #{in_ddsim}")
