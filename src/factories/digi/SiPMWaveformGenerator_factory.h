...
namespace eicrecon {
  ...
  // --------------------------------------------------------------------------
  //! SiPM Waveform Generator factory
  // --------------------------------------------------------------------------
  /*! Generic factory to run the SiPMWaveformGenerator algorithm.
   */ 
  class SiPMWaveformGenerator_factory : public JOmniFactory<SiPMWaveformGenerator_factory, SiPMWaveformGeneratorConfig> {
